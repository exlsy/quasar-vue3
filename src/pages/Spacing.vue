  ...
  <q-page class="q-pa-xl">
    <section class="q-mb-xl">
      ...
      <div class="bg-primary q-pa-xs">
        <div class="bg-dark text-white">
          ...
          tempora nisi vero distinctio, doloremque asperiores nesciunt odio
          voluptas maxime voluptate, repellendus nemo repellat delectus
          voluptates doloribus, reprehenderit ratione ab excepturi.
        </div>
      </div>
    ...
    <section class="q-mb-xl">
      ...
      >
        ...
        <q-card-actions>
          <q-btn padding="md" outline>Action 1</q-btn>
          <q-btn padding="2px 2px 5px 7px" outline>Action 2</q-btn>
        </q-card-actions>
      </q-card>
    </section>
  </q-page>
